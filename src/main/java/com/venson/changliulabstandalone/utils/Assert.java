...
public abstract class Assert {
     ...
     * <p>Call {@link #isTrue} if you wish to throw an {@code CustomizedException}
    ...
    public static void state(boolean expression,Supplier<String> messageSupplier) {
        if (!expression) {
            throw new CustomizedException(nullSafeGet(messageSupplier));
        }
    }


    /**
     * Assert a boolean expression, throwing an {@code CustomizedException}
     * if the expression evaluates to {@code false}.
     * <pre class="code">Assert.isTrue(i &gt; 0, "The value must be greater than zero");</pre>
     * @param expression a boolean expression
     * @param message the exception message to use if the assertion fails
     * @throws CustomizedException if {@code expression} is {@code false}
     */
     ...
     * @param message the exception message to use if the assertion fails
     * @throws CustomizedException if the object is not {@code null}
     */
     ...
     * @param object the object to check
     * @param message the exception message to use if the assertion fails
     * @throws CustomizedException if the object is {@code null}
     */
     ...
     * @param message the exception message to use if the assertion fails
     * @throws CustomizedException if the text is empty
     ...
     * @param text the String to check
     * @param message the exception message to use if the assertion fails
     * @throws CustomizedException if the text does not contain valid text content
     ...
     * @param message the exception message to use if the assertion fails
     * @throws CustomizedException if the text contains the substring
     */
     ...
     * @param message the exception message to use if the assertion fails
     * @throws CustomizedException if the object array is {@code null} or contains no elements
     */
     ...
     * @param array the array to check
     * @param message the exception message to use if the assertion fails
     * @throws CustomizedException if the object array contains a {@code null} element
     */
     ...
     * @param message the exception message to use if the assertion fails
     * @throws CustomizedException if the collection is {@code null} or
     ...
     * @param collection the collection to check
     * @param message the exception message to use if the assertion fails
     * @throws CustomizedException if the collection contains a {@code null} element
     * @since 5.2
     */
     ...
     * @param message the exception message to use if the assertion fails
     * @throws CustomizedException if the map is {@code null} or contains no entries
     */
     ...
     * @throws CustomizedException if the object is not an instance of type
     */
     ...
     * @throws CustomizedException if the classes are not assignable
     */
    ...
    private static void instanceCheckFailed(Class<?> type, @Nullable Object obj, @Nullable String msg) {
        ...
        throw new CustomizedException(result);
    }
